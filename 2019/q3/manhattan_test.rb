...
class Matrix
  ...
  def moves(arr)
    ...
    arr.each do |move|
      ...
      case direction
      when 'R' then
        (1..amount).each { pos.x += 1; pos.num += 1; yield pos }
      when 'L' then
        (1..amount).each { pos.x -= 1; pos.num += 1; yield pos }
      when 'U' then
        (1..amount).each { pos.y += 1; pos.num += 1; yield pos }
      when 'D' then
        (1..amount).each { pos.y -= 1; pos.num += 1; yield pos }
