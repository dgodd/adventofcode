...
describe 'find the intersection point closest to the central port' do
  describe 'R8,U5,L5,D3 & U7,R6,D4,L4' do
    it '#intersection' do
      matrix = Matrix.new('R8,U5,L5,D3'.split(','))
      actual = matrix.intersections('U7,R6,D4,L4'.split(','))
      assert_equal [Matrix::Pos.new(6, 5, 30), Matrix::Pos.new(3, 3, 40)], actual
    end

    it '#closest_intersection' do
      matrix = Matrix.new('R8,U5,L5,D3'.split(','))
      actual = matrix.closest_intersection('U7,R6,D4,L4'.split(','))
  ...
  describe 'R75,D30,R83,U83,L12,D49,R71,U7,L72 & U62,R66,U55,R34,D71,R55,D58,R83' do
    it '#closest_intersection' do
      ...
      assert_equal 159, Matrix.new(x).closest_intersection(y)
    end
  end
  ...
  describe 'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51 & U98,R91,D20,R16,D67,R40,U7,R15,U6,R7' do
    it '#closest_intersection' do
      ...
      assert_equal 135, Matrix.new(x).closest_intersection(y)
    end
  end
...
'.split(',')
      assert_equal 258, Matrix.new(x).closest_intersection(y)
    end
  end
  ...
  it 'shortest - example 1' do
    x = 'R8,U5,L5,D3'.split(',')
    y = 'U7,R6,D4,L4'.split(',')
    assert_equal 30, Matrix.new(x).shortest_intersection(y)
  end

  it 'shortest - example 2' do
    x = 'R75,D30,R83,U83,L12,D49,R71,U7,L72'.split(',')
    y = 'U62,R66,U55,R34,D71,R55,D58,R83'.split(',')
    assert_equal 610, Matrix.new(x).shortest_intersection(y)
  end

  it 'shortest - example 3' do
    x = 'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51'.split(',')
    y = 'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7'.split(',')
    assert_equal 410, Matrix.new(x).shortest_intersection(y)
  end
  ...
  it 'part 2 - shortest' do
    ...
    y = 'L998,U662,R342,U104,R140,U92,R67,D102,L225,U265,R641,U592,L295,D77,R415,U908,L640,D381,R312,U44,R424,D847,R892,D625,L337,D344,L917,D914,R127,D273,L627,U812,L200,D262,R226,U273,R911,U597,L888,U28,R921,U464,R254,U771,R818,D808,L239,D225,L280,U785,R322,D831,L622,U506,R139,U12,L491,D572,L172,U685,R54,U747,L812,D717,R874,U428,L867,U174,R360,D36,R217,D539,R210,D791,L82,D665,L190,D313,R649,U849,R63,U385,R105,U806,L207,U697,L823,D272,R830,D952,L386,U987,R775,U517,R139,D756,R545,D973,L743,D286,R261,U448,R946,U884,L903,D142,R28,D374,R259,U403,R689,D245,L302,D134,R710,U762,L67,D561,R801,D140,L887,U346,L227,U682,L350,D218,L711,U755,R226,D277,R114,D61,R992,U602,L191,U640,R733,D329,R862,U242,R754,D161,L52,D974,L251,D444,L552,U977,R174,U483,R869,D955,R925,U693,R610,D353,L843,U148,L866,D167,R412,D31,L847,D979,L282,D797,L837,U473,L402,U193,L332,D603,R48,D589,L760,D673,L843,U428,R779,D592,L688,D141,R851,D642,R559,U939,R999,D64,L297,U817,R670,U322,L768,D936,L39,U95,L342,U849,L692,U714,L732,D734,L373,U66,L577,D453,R336,U760,L217,U542,R920,U24,R529,D594,L34,D79,R877,D965,R932,U460,R879,U26,R803,U876,L780,U956,L235,D270,L315,D577,R835,U750,R414,D584,L828,U335,L563,U238,L815,U780,L550,U18,R743,D54,L816,U344,L806,D197,L518,D682,L835,U255,L666,U442,L286,D543,R102,D52,L570,D787,L763,D223,R279,D892,L828,D111,L554,D452,R575,D299,R932,D187,L439,U616,L278,D701,L360,D524,L891,U953,L896,U788,R776,U782,L71,D741,L652,U121,R669,D809,L662,U319,R392,D313,R870,U794,R937,D469,R571,D761,R947
    '.split(',')
    assert_equal 12304, Matrix.new(x).shortest_intersection(y)
  end
end
